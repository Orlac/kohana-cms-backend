...
abstract class Captcha
{
	...
	public function image_render($html)
	{
		// Output html element
		if ($html === TRUE)
			return '<img src="'.url::site('captcha/'.Captcha::$config['group']).'" width="'.Captcha::$config['width'].'" height="'.Captcha::$config['height'].'" onclick="this.src=\''.url::site('captcha/'.Captcha::$config['group']).'\'+parseInt( Math.random()*1000 )" title="'.I18n::get('reload image').'" alt="Captcha" class="captcha" />';
